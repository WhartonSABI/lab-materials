...
# The sample size is n = 3469

# timeout rate
mean(analysis_data$timeout_now)

# 14.49986% of those samples resulted in a timeout
...
# The overlap looks decently strong.
...
# covariate                       smd
# <chr>                         <dbl>
#   1 swing_last_180             -0.00610
# 2 current_margin              0.00366
# 3 period_number               0.141  
# 4 end_game_seconds_remaining -0.148  
# 5 home_focal                 -0.0346 
# 6 pregame_spread_focal       -0.0346 
...
# method                estimate
# <chr>                    <dbl>
# 1 Naive difference      -0.00149
# 2 Regression adjustment  0.0258 
# 3 Matching ATT          -0.0258 
# 4 IPW                   -0.0303 

# The estimates disagree. This is likely due to a difference in their assumptions about the covariates.
...
# Other factors not included in the model, like fatigue, could contribute to confounding.
# The coefficient is low, so a casual claim I'm willing to make is that whether or not a timeout is
# called doesn't have that much to do with it.
